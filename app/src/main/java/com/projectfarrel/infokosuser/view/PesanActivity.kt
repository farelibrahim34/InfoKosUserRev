...
class PesanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val nKamar = intent.getStringExtra("noKamar")
        val idKos = intent.getStringExtra("idKos")
        binding.etNoKamar.setText(nKamar)
        ...
        binding.btnPesan.setOnClickListener {
            ...
            postPesan(nama,namaKos,noHp,noKamar,tgl,status,idKos.toString())
            val intent = Intent(this, HomeActivity::class.java)
            startActivity(intent)
    ...
    fun postPesan(nama: String,
        ...
        viewModel.callPostPesanKos(nama,namaKos,noHp,noKamar,tglpesan,status,idKos)
